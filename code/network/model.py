...
def _segm_resnet(name, backbone_name, num_classes, output_stride, arma):
    if output_stride==8:
...
def deeplabv3_resnet50(num_classes=19, output_stride=8, arma=False):
    ...
    Args:
        ...
        arma: boolean value
    """
    return _load_model('deeplabv3', 'resnet50', num_classes, output_stride=output_stride, arma=arma)

def deeplabv3_resnet101(num_classes=19, output_stride=8, arma=False):
    ...
    Args:
        ...
        arma: boolean value
    """
    return _load_model('deeplabv3', 'resnet101', num_classes, output_stride=output_stride, arma=arma)
...
def deeplabv3plus_resnet50(num_classes=19, output_stride=8, arma=False):
    ...
    Args:
        ...
        arma: boolean value
    """
    return _load_model('deeplabv3plus', 'resnet50', num_classes, output_stride=output_stride, arma=arma)

def deeplabv3plus_resnet101(num_classes=19, output_stride=8, arma=False):
    """Constructs a DeepLabV3+ model with a ResNet-101 backbone.
    Args:
        num_classes (int): number of classes.
        output_stride (int): output stride for deeplab.
